...
module "gcp-blogs-ga4-analytics" {
  ...
  trigger_patterns    = ["/gcp-blogs-ga4-analytics/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-ga4-user-admin-tool-dev" {
  ...
  trigger_patterns    = ["/gcp-ga4-user-admin-tool-dev/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-gcp-admin-di" {
  ...
  trigger_patterns    = ["/gcp-gds-gcp-admin-di/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-gcp-admin-search" {
  ...
  trigger_patterns    = ["/gcp-gds-gcp-admin-search/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-bigquery-analytics" {
  ...
  trigger_patterns    = ["/gcp-govuk-bigquery-analytics/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-polling" {
  ...
  trigger_patterns    = ["/gcp-govuk-polling/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-sde-consent-api" {
  ...
  trigger_patterns    = ["/gcp-sde-consent-api/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-cpto-content-metadata" {
  ...
  trigger_patterns    = ["/gcp-cpto-content-metadata/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-cpto-spam-classifier" {
  ...
  trigger_patterns    = ["/gcp-cpto-spam-classifier/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-data-insights-experimentation" {
  ...
  trigger_patterns    = ["/gcp-data-insights-experimentation/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-disco-journeys" {
  ...
  trigger_patterns    = ["/gcp-disco-journeys/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-bq-data" {
  ...
  trigger_patterns    = ["/gcp-gds-bq-data/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-bq-reporting" {
  ...
  trigger_patterns    = ["/gcp-gds-bq-reporting/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-ga-archive" {
  ...
  trigger_patterns    = ["/gcp-gds-ga-archive/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-looker" {
  ...
  trigger_patterns    = ["/gcp-gds-looker/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-gds-social-data" {
  ...
  trigger_patterns    = ["/gcp-gds-social-data/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-content-data" {
  ...
  trigger_patterns    = ["/gcp-govuk-content-data/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-govsearch" {
  ...
  trigger_patterns    = ["/gcp-govuk-govsearch/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-publishing" {
  ...
  trigger_patterns    = ["/gcp-govuk-publishing/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-s3-mirror" {
  ...
  trigger_patterns    = ["/gcp-govuk-s3-mirror/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-govuk-user-feedback" {
  ...
  trigger_patterns    = ["/gcp-govuk-user-feedback/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-sde-analysis" {
  ...
  trigger_patterns    = ["/gcp-sde-analysis/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-sde-consent-api-dev" {
  ...
  trigger_patterns    = ["/gcp-sde-consent-api-dev/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-sde-prototype-service" {
  ...
  trigger_patterns    = ["/gcp-sde-prototype-service/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-sde-sandbox-haas" {
  ...
  trigger_patterns    = ["/gcp-sde-sandbox-haas/**/*"]
  global_remote_state = true
  assessments_enabled = true
...
module "gcp-single-consent-api-dev" {
  ...
  trigger_patterns    = ["/gcp-single-consent-api-dev/**/*"]
  global_remote_state = true
  assessments_enabled = true
