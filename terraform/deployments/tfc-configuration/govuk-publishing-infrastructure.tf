...
module "govuk-publishing-infrastructure-variable-set-integration" {
  ...
  tfvars = {
    subdomain_dns_records = [
      ...
      { type = "CNAME", name = "content-publisher", ttl = 3600, value = ["content-publisher.eks.integration.govuk.digital."] },
      ...
      { type = "CNAME", name = "maslow", ttl = 3600, value = ["maslow.eks.integration.govuk.digital."] },
...
module "govuk-publishing-infrastructure-variable-set-staging" {
  ...
  tfvars = {
    subdomain_dns_records = [
      ...
      { type = "CNAME", name = "content-publisher", ttl = 3600, value = ["content-publisher.eks.staging.govuk.digital."] },
      ...
      { type = "CNAME", name = "maslow", ttl = 3600, value = ["maslow.eks.staging.govuk.digital."] },
...
module "govuk-publishing-infrastructure-variable-set-production" {
  ...
  tfvars = {
    subdomain_dns_records = [
      ...
      { type = "CNAME", name = "content-publisher", ttl = 3600, value = ["content-publisher.eks.production.govuk.digital."] },
      ...
      { type = "CNAME", name = "maslow", ttl = 3600, value = ["maslow.eks.production.govuk.digital."] },
