module "serving_config_default_global" {
  ...
  boost_control_ids = [
    ...
    module.control_boost_demote_strong_global.id,
...
module "control_boost_promote_medium_global" {
...
module "control_boost_promote_low_global" {
  source = "./modules/control"
...
module "control_boost_demote_low_global" {
  source = "./modules/control"
...
module "control_boost_demote_medium_global" {
  source = "./modules/control"
...
module "control_boost_demote_strong_global" {
  source = "./modules/control"
...
module "control_boost_demote_pages_global" {
  source = "./modules/control"
...
module "control_synonym_hmrc_global" {
  source = "./modules/control"
