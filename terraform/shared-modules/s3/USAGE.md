...
| <a name="input_disable_bucket_logging"></a> [disable\_bucket\_logging](#input\_disable\_bucket\_logging) | Do not configure bucket logging. This is ONLY allowed in test, or for the logging bucket itself. | `bool` | `false` | no |
