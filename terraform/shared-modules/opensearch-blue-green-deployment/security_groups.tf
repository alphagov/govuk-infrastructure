...
resource "aws_security_group_rule" "opensearch_cluster_from_old_elasticsearch_cluster_https" {
  for_each = var.override_security_group_ids_for_green_cluster == null ? [] : toset(var.override_security_group_ids_for_green_cluster)
...
resource "aws_security_group_rule" "old_elasticsearch_cluster_from_opensearch_cluster_https" {
  for_each = var.override_security_group_ids_for_green_cluster == null ? [] : toset(var.override_security_group_ids_for_green_cluster)
...
resource "aws_security_group_rule" "opensearch_cluster_to_old_elasticsearch_cluster_https" {
  for_each = var.override_security_group_ids_for_green_cluster == null ? [] : toset(var.override_security_group_ids_for_green_cluster)
...
resource "aws_security_group_rule" "old_elasticsearch_cluster_to_opensearch_cluster_https" {
  for_each = var.override_security_group_ids_for_green_cluster == null ? [] : toset(var.override_security_group_ids_for_green_cluster)
