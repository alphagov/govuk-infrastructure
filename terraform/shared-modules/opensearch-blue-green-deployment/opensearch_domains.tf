...
module "blue_domain" {
  ...
  create_vpc_endpoint = var.blue_cluster_options.create_vpc_endpoint // || var.create_remote_connection_to_import_to_green_from_blue // I think the vpc endpoint is being made automatically
}
